...
# FreezeShift adapts the last few encoder blocks instead of leaving the tower fully
# frozen. rank-128 branches on the attention projections, backbone weights untouched
