...
class TextEncoder(nn.Module):
    """Pretrained text encoder wrapper. Captions are tokenised inside forward()."""
    ...
    def forward_token_features(
        ...
        This is intentionally unavailable for the already-pooled OpenCLIP
        wrapper. Hugging Face encoders retain their checkpoint-native
        tokenisation and remain frozen.
        """
